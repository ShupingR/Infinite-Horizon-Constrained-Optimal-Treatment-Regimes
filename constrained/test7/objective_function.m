...
function obj = objective_function( tau, sample_pos )  %, T )
    ...
    weight = lspi(algorithm, maxiteration, epsilon, sample_pos, initial_policy_weight, tau);
    
    val_pol = 0;
    for each_sample = sample_pos
    ...
    obj = -1 * val_pol / length(sample_pos);
